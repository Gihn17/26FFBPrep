...
/* ============================================================
   ...
   the GM Tab and the Koi board. A genuinely separate cost from Claude
   Code's own subscription (which the fantasy-gm terminal agents run
   under) — real-time browser chat needs a live backend LLM call, which
   nothing about Claude Code can do from inside a web page. Stored the
